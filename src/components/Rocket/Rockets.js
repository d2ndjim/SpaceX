...
import { fetchRockets, updateReserved } from '../../redux/rocketSlice/rocketsSlice';
        ...
        {rockets.map((rocket) => (
          <div key={rocket.id} className={classes.container}>
            ...
            <div className={classes.info}>
              ...
              {rocket.reserved && (<button type="button" className={classes.cancelBtn} onClick={() => clickHandler(rocket.id)}>Cancel Reservation</button>)}
              {!rocket.reserved && (
